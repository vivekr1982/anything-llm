...
function apiDocumentEndpoints(app) {
  ...
  app.post(
    ...
    #swagger.description = 'Upload a new file to CloudwiseGPT to be parsed and prepared for embedding.'
    #swagger.requestBody = {
        ...
        "application/json": {
          schema: {
            ...
            example: {
              ...
              documents: [
                {
                  "location": "custom-documents/cloudwisegpt.txt-6e8be64c-c162-4b43-9997-b068c0071e8b.json",
                  "name": "cloudwisegpt.txt-6e8be64c-c162-4b43-9997-b068c0071e8b.json",
                  "url": "file:///Users/tim/Documents/cloudwise-gpt/collector/hotdir/cloudwisegpt.txt",
                  "title": "cloudwisegpt.txt",
                  "docAuthor": "Unknown",
                  "description": "Unknown",
                  "docSource": "a text file uploaded by the user.",
                  "chunkSource": "cloudwisegpt.txt",
  ...
  app.post(
    ...
    async (request, response) => {
      /*
    #swagger.tags = ['Documents']
    #swagger.description = 'Upload a valid URL for CloudwiseGPT to scrape and prepare for embedding.'
    #swagger.requestBody = {
              ...
              documents: [
                {
                  ...
                  "chunkSource": "https:cloudwisegpt.com.html",
                  "published": "1/16/2024, 3:46:33 PM",
                  "wordCount": 252,
                  "pageContent": "CloudwiseGPT is the best....",
      ...
      content: {
        "application/json": {
          schema: {
            type: 'object',
            example: {
              "textContent": "This is the raw text that will be saved as a document in CloudwiseGPT.",
              "metadata": {
  ...
  app.get("/v1/document/:docName", [validApiKey], async (request, response) => {
    /*
    #swagger.tags = ['Documents']
    #swagger.description = 'Get a single document by its unique CloudwiseGPT document name'
