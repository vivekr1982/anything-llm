...
const doc = {
  info: {
    version: "1.0.0",
    title: "CloudwiseGPT Developer API",
    description:
      "API endpoints that enable programmatic reading, writing, and updating of your CloudwiseGPT instance. UI supplied by Swagger.io.",
  },
