  ...
  #defaultMeta() {
    return [
      ...
      },
      {
        tag: "title",
        props: null,
        content: "CloudwiseGPT | Your personal LLM trained on anything",
      },
      ...
      {
        tag: "meta",
        props: { property: "og:url", content: "https://cloudwisegpt.com" },
      },
      {
        tag: "meta",
        props: {
      ...
      },
      {
        ...
        props: {
          property: "og:image",
          content:
            "https://raw.githubusercontent.com/Mintplex-Labs/cloudwise-gpt/master/images/promo.png",
        },
      },
      ...
      {
        tag: "meta",
        props: { property: "twitter:url", content: "https://cloudwisegpt.com" },
      },
      {
        tag: "meta",
        props: {
    ...
    if (customTitle === null && faviconURL === null) {
      ...
      this.#customConfig = [
        ...
        },
        {
          ...
          content:
            customTitle ??
            "CloudwiseGPT | Your personal LLM trained on anything",
        },
      ];
    }
