...
function FeatureVerification({ children }) {
  if (
    !window.localStorage.getItem("cloudwisegpt_tos_experimental_feature_set")
  ) {
    function acceptTos(e) {
      e.preventDefault();

      window.localStorage.setItem(
        "CloudwiseGPT_tos_experimental_feature_set",
        "accepted"
      );
      showToast(
            ...
            <div className="relative bg-main-gradient rounded-lg shadow">
              ...
              <div className="p-6 space-y-6 flex h-full w-full">
                <div className="w-full flex flex-col gap-y-4 text-white">
                  <p>
                    Experimental features of CloudwiseGPT are features that we
                  ...
                  <div>
                    ...
                    <ul className="list-disc ml-6 text-sm font-mono">
                      ...
                      <li>Potential bugs or issues using CloudwiseGPT.</li>
                    </ul>
                  </div>
                  ...
                  <div>
                    ...
                    <ul className="list-disc ml-6 text-sm font-mono">
                      ...
                      <li>
                        ...
                        configurations, or subscriptions of CloudwiseGPT.
                      </li>
                      <li>
